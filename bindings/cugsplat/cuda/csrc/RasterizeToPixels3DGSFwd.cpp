...
std::tuple<at::Tensor, at::Tensor, at::Tensor> image_gaussian_rasterize_forward(
    ...
    // Create outputs
    at::Tensor render_last_index = at::empty({n_images, image_height, image_width, 1}, means2d.options().dtype(at::kInt));
    at::Tensor render_alpha = at::empty({n_images, image_height, image_width, 1}, means2d.options());
    at::Tensor render_feature = at::empty({n_images, image_height, image_width, channels}, means2d.options());
